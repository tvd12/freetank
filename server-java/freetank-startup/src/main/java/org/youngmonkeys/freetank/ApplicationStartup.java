package org.youngmonkeys.freetank;
...
import org.youngmonkeys.freetank.plugin.PluginEntry;
import org.youngmonkeys.freetank.plugin.PluginEntryLoader;
import org.youngmonkeys.freetank.app.AppEntry;
import org.youngmonkeys.freetank.app.AppEntryLoader;

public class ApplicationStartup {
	
	public static final String ZONE_APP_NAME = "freetank"; 
		...
		public EzyPluginEntry load() throws Exception {
			return new PluginEntry() {
				...
				private String getPluginPath(EzyPluginSetting setting) {
					Path pluginPath = Paths.get("freetank-plugin");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../freetank-plugin");
		...
		public EzyAppEntry load() throws Exception {
			return new AppEntry() {
				...
				private String getAppPath() {
					Path pluginPath = Paths.get("freetank-app-entry");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../freetank-app-entry");
					return pluginPath.toString();
				}
			};
		}
